...
El código fuente completo del Sistema de Gestión de Solicitudes de Soporte Técnico de Internet, incluyendo la configuración de los microservicios \texttt{ticket-service} y \texttt{report-service} analizados en este informe, se encuentra disponible en el repositorio del equipo ACC:
\begin{center}
\url{https://github.com/CristhianP03/TA-IND-02-Informe-Tecnico-Individual}
\end{center}
% ============================================================
% 2. MARCO TEÓRICO
% ============================================================
